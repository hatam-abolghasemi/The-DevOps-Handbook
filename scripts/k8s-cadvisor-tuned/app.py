...
# Configuration
SCRAPE_URL = "https://kubernetes.default.svc:443/api/v1/nodes/{}/proxy/metrics/cadvisor"
...
def update_metrics_periodically():
    ...
    while True:
        ...
        time.sleep(3)  # Sleep for 3 seconds between updates
